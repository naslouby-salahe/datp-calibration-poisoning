"""Tests for CP2 deterministic seed derivation."""
...
class TestDeriveCp2SeedRecord:
    ...
    def test_is_cp2_seed_record_instance(self) -> None:
        record = derive_cp2_seed_record(
            training_seed=0, poisoning_seed=100, client_idx=0, scope_idx=0
        )
        assert isinstance(record, Cp2SeedRecord)


class TestMakeCp2Rng:
    ...
    def test_all_cp2_seed_pairs_produce_distinct_sequences(self) -> None:
