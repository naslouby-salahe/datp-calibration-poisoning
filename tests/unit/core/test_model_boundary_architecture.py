"""Architecture compliance tests validating boundaries, models, types, and directory layouts."""
...
class TestValidationCheckArchitecture:
    """Tests verifying schemas and type constraints in the validation module."""

    def test_validation_check_exists(self) -> None:
        """Confirm ValidationCheck class is defined in schemas module."""
    ...
    def test_validation_check_has_code_status_detail(self) -> None:
        """Confirm ValidationCheck has code, status, and detail fields."""
    ...
    def test_metric_check_result_absent(self) -> None:
        """Confirm obsolete MetricCheckResult has been removed."""
    ...
    def test_score_check_result_absent(self) -> None:
        """Confirm obsolete ScoreCheckResult has been removed."""
        module = importlib.import_module("datp.validation.metric_reproducer")
    ...
    def test_verdict_reason_entry_absent(self) -> None:
        """Confirm obsolete VerdictReasonEntry has been removed."""
    ...
    def test_score_cell_verification_uses_training_cell_id(self) -> None:
        """Confirm ScoreCellVerification references the canonical TrainingCellId."""
        from datp.core.identity import TrainingCellId
    ...
    def test_cell_verdict_uses_training_cell_id(self) -> None:
        """Confirm CellVerdict references the canonical TrainingCellId."""
        from datp.core.identity import TrainingCellId
    ...
    def test_score_cell_verification_no_loose_identity(self) -> None:
        """Ensure ScoreCellVerification does not retain legacy metadata fields."""
        from datp.validation.score_manifest import ScoreCellVerification
    ...
    def test_cell_verdict_no_loose_identity(self) -> None:
        """Ensure CellVerdict does not retain legacy metadata fields."""
        from datp.validation.verdicts import CellVerdict
...
class TestArtifactPathContracts:
    ...
    def test_score_cell_paths_has_checkpoint_dir_and_score_dir(self) -> None:
        """Confirm ScoreCellPaths exposes checkpoint and score storage locations."""
        from datp.artifacts.layout import ScoreCellPaths
...
class TestCLIAccumulatorsAllowlisted:
    ...
    def test_stage_report_is_private(self) -> None:
        ...
        module = importlib.import_module("datp.cli.commands")
        assert hasattr(module, "_StageReport"), (
            "_StageReport must exist as a private CLI accumulator in datp.cli.commands"
        )
    ...
    def test_status_report_is_private(self) -> None:
        ...
        assert hasattr(module, "_StatusReport"), (
            "_StatusReport must exist as a private CLI accumulator in datp.cli.commands"
        )
