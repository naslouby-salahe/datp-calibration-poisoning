"""Unit tests for the experiment executor orchestration."""
...
class TestSharedTrainingExecutor:
    """SharedTrainingExecutor instantiation and context building."""
...
class TestThresholdEvaluationExecutor:
    """ThresholdEvaluationExecutor run and step forwarding."""
...
class TestEnsureFlCheckpoint:
    """Checkpoint lock-and-recover logic."""
