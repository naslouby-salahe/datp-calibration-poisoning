"""Unit tests for configuration preview and dry-run output."""
...
class TestComposeRequest:
    """ComposeRequest defaults and CLI parsing."""
...
class TestComposeConfig:
    """Config composition from base + overrides."""
    ...
    def test_basic_composition(self) -> None:
        ...
        assert cfg.threshold.q == pytest.approx(95)

    def test_invalid_stage(self) -> None:
        with pytest.raises(ComposeError, match=r"\[config\]"):
