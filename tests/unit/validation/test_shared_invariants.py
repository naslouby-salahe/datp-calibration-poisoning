"""Tests verifying threshold policy shared invariants (split, model, scoring/metrics code hashes, reconstruction errors)."""
...
class TestInvariantPass:
    ...
    def test_synthetic_smoke_controlled_policies_pass(self) -> None:
        """Verify that matching inputs pass on synthetic smoke stages."""
        baselines = [
            ThresholdPolicy.GLOBAL_THRESHOLD,
            ThresholdPolicy.LOCAL_THRESHOLD,
            ThresholdPolicy.CLUSTER_THRESHOLD,
    ...
    def test_nbaiot_full_controlled_policies_pass(self) -> None:
        """Verify that matching inputs pass on full/optional NBAIoT stages."""
        baselines = [
            ThresholdPolicy.GLOBAL_THRESHOLD,
            ThresholdPolicy.LOCAL_THRESHOLD,
            ThresholdPolicy.CLUSTER_THRESHOLD,
...
class TestInvariantFail:
    ...
    def test_model_hash_differs_marks_fail(self) -> None:
        """Verify model checkpoint hash mismatches result in audit FAIL status."""
        baselines = [
            ThresholdPolicy.GLOBAL_THRESHOLD,
            ThresholdPolicy.LOCAL_THRESHOLD,
            ThresholdPolicy.CLUSTER_THRESHOLD,
