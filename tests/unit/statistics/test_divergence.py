"""Unit tests for statistical divergence computations."""
...
class TestPairwiseJsDivergence:
    """Pairwise Jensen-Shannon divergence computation."""
...
class TestPairwiseJsSummary:
    """Aggregate JS divergence summaries."""
...
class TestPairwiseJsFromDistributions:
    """JS divergence from raw distribution arrays."""
