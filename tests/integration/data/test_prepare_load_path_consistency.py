"""Verify consistency between prepare_nbaiot output and load_client_data input paths."""
...
class TestPrepareLoadPathConsistency:
    ...
    def test_discover_client_dirs_finds_devices(self, prepared_dir: Path) -> None:
        """Client directory discovery finds all prepared devices."""
    ...
    def test_load_client_data_succeeds(self, prepared_dir: Path) -> None:
        """All splits load successfully for every device."""
    ...
    def test_no_extra_nesting(self, prepared_dir: Path) -> None:
        """Prepared output has no extra nbaiot/ subdirectory nesting."""
