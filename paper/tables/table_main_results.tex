...
Lowering rows ($\dagger$) report $\Delta\mathrm{CV(FPR)}$, an FPR-disparity metric, as a seed-level mean with no bootstrap interval estimated; Neg.\,Control: Random-Benign at $f{=}0.4$, pooled over both objectives; bold=zero G1.}
