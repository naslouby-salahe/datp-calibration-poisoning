...
$\Delta\tau$: mean shift [95\% CI]; G1: Gate-1 seed pass rate; $\Delta$TPR: victim detection-rate change.
Lowering rows ($\dagger$) report $\Delta\mathrm{CV(FPR)}$, an FPR-disparity metric, as a seed-level mean with no bootstrap interval estimated; Neg.\,Control: Random-Benign at $f{=}0.4$, pooled over both objectives; bold indicates G1 = 0\%.}
...
\midrule
\GLOBAL & Neg.~Ctrl & 0.4 & $-0.000\;[-0.001,\,+0.001]$ & \textbf{0\%} & $+0.3$ & --- \\
\LOCAL & Neg.~Ctrl & 0.4 & $-0.002\;[-0.009,\,+0.006]$ & \textbf{0\%} & $+0.9$ & --- \\
\CLUSTER & Neg.~Ctrl & 0.4 & $-0.009\;[-0.022,\,+0.003]$ & \textbf{0\%} & $+0.4$ & --- \\
\bottomrule
\end{tabular}
\end{table}
